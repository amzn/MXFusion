...
class TestSVGPRegressionModule(object):
    ...
    def test_module_clone_prediction(self):
        ...
        m, gp = self.gen_mxfusion_model(dtype, D, Z, noise_var, lengthscale, variance)
        ...
        infr2_clone.inference_algorithm.model.Y.factor.svgp_predict.diagonal_variance = False
        infr2_clone.inference_algorithm.model.Y.factor.svgp_predict.noise_free = False
