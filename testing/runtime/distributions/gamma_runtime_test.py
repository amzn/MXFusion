...
import mxnet as mx
import numpy as np
from mxfusion.runtime.distributions import GammaRuntime
from mxfusion.components.variables.runtime_variable import add_sample_dimension


@pytest.mark.usefixtures("set_seed")
class TestGammaRuntimeDistribution(object):
    ...
    def test_log_pdf(self, dtype, a, b, rv):
        ...
        log_pdf_np = gamma.logpdf(rv, a=a, loc=0, scale=1. / b)
        ...
        beta_dist = GammaRuntime(alpha=alpha_mx, beta=beta_mx)
